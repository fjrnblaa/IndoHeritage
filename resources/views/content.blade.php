        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="/information" class="nav-item nav-link">Purpose</a>
            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white mb-3 animated slideInDown">Culture</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="{{ asset('storage/' . $content->image) }}" alt="" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h1 class="mb-4">{{$content->title}}</h1>
                    <p class="mb-4">{!! nl2br($content->description) !!}</p>   
                </div>
                <div class="position-relative w-75 mx-auto animated slideInDown">
                        <div class="d-flex justify-content-center">
                            @if(auth()->check() && auth()->user()->role === 'admin')
                                <a href="/dashboard" class="btn btn-primary rounded-pill py-2 px-4" style="margin-top: 7px;">Back</a>
                            @else
                                <a href="/cultures" class="btn btn-primary rounded-pill py-2 px-4" style="margin-top: 7px;">Back</a>  
                            @endif
                        </div>
                </div>
            </div>
