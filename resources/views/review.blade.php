        ...
        <form action="{{ url('/review/input') }}">
          <div class="topic">Give Review</div>
            @guest
                ...
                <div class="input-box">
                    <a href="/index" class="btn btn-primary rounded-pill py-2 px-4">Login</a>
                </div>
            @else
                <div class="input-box">
                ...
                <div class="message-box">
                    <textarea rows="1" name="review" class="auto_height" oninput="auto_height(this)" required></textarea>
